 ...
 */
public class ReportForM2_LineChar_Activity extends FragmentActivity implements View.OnClickListener,PopupWindow.OnDismissListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_month2);
    ...
    private void initView(){
        ...
        // 年份月份
        mTvMonth1 = (TextView) findViewById(R.id.tv_month1);
        mTvMonth2 = (TextView) findViewById(R.id.tv_month2);
        mTvMonth3 = (TextView) findViewById(R.id.tv_month3);
        mTvMonth4 = (TextView) findViewById(R.id.tv_month4);
        mTvMonth5 = (TextView) findViewById(R.id.tv_month5);
    ...
    private void initListener() {
        ...
        // 年份月份
        mTvMonth1.setOnClickListener(this);
        mTvMonth2.setOnClickListener(this);
        mTvMonth3.setOnClickListener(this);
        mTvMonth4.setOnClickListener(this);
        mTvMonth5.setOnClickListener(this);
    ...
    private void initDate() {
        ...
        mTvTitle.setText("月报表");

        /*******************************年份****************************************/
        mTvMonth1.setEnabled(true);
        mTvMonth2.setEnabled(false);
        mTvMonth3.setEnabled(false);
        mTvMonth4.setEnabled(false);
        mTvMonth5.setEnabled(false);
        ...
        pvTimeYearMonth.setOnTimeSelectListener(new TimePickerView.OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date) {
                ...
                mBlM1 = mTvMonth1.isEnabled();
                mBlM2 = mTvMonth2.isEnabled();
                mBlM3 = mTvMonth3.isEnabled();
                mBlM4 = mTvMonth4.isEnabled();
                mBlM5 = mTvMonth5.isEnabled();

                if(mBlM1 && !mBlM2 && !mBlM3 && !mBlM4 && !mBlM5 ) {
                    mNum = 1;
                    mTvMonth2.setEnabled(true);
                    mTvMonth1.setText(DateTimeFormat.getTime(date, "yyyy-MM"));
                }
                if(mBlM1 && mBlM2 && !mBlM3 && !mBlM4 && !mBlM5 ) {
                    if(mCurrent == 1){
                        mTvMonth1.setText(DateTimeFormat.getTime(date, "yyyy-MM"));
                        ...
                        mNum = 2;
                        mTvMonth3.setEnabled(true);
                        mTvMonth2.setText(DateTimeFormat.getTime(date, "yyyy-MM"));
                    }
                }
                if(mBlM1 && mBlM2 && mBlM3 && !mBlM4 && !mBlM5 ) {
                    if(mCurrent == 1){
                        ...
                        mNum = 3;
                        mTvMonth4.setEnabled(true);
                        mTvMonth3.setText(DateTimeFormat.getTime(date, "yyyy-MM"));
                    }
                }
                if(mBlM1 && mBlM2 && mBlM3 && mBlM4 && !mBlM5 ) {
                    if(mCurrent == 1){
                        ...
                        mNum = 4;
                        mTvMonth5.setEnabled(true);
                        mTvMonth4.setText(DateTimeFormat.getTime(date, "yyyy-MM"));
                    }
                }
                if(mBlM1 && mBlM2 && mBlM3 && mBlM4 && mBlM5 ) {
                    if(mCurrent == 1){
                        ...
                        mNum = 5;
                        mTvMonth5.setText(DateTimeFormat.getTime(date, "yyyy-MM"));
                    }
                }
            }
        });
    ...
    private void showPopupWindow() {
        ...
        if (pop.isShowing()) {
            ...
            mPopCbToggleLabels.setChecked(SharePrefUtil.getBoolean(getApplicationContext(),SharePrefUtil.REPORT_KEY.TOGGLELABELS_MONTH_ISCHECK,false));
            mPopCbToggleFilled.setChecked(SharePrefUtil.getBoolean(getApplicationContext(),SharePrefUtil.REPORT_KEY.TOGGLEFILLED_MONTH_ISCHECK,false));
            mPopCbSelectYX.setChecked(SharePrefUtil.getBoolean(getApplicationContext(),SharePrefUtil.REPORT_KEY.SELECTYX_MONTH_ISCHECK,false));
    ...
    private void saveStyle(){
        ...
        if(mPopRbX.isChecked()) {
            SharePrefUtil.saveInt(getApplicationContext(), SharePrefUtil.REPORT_KEY.SELECTYX_MONTH_TYPE, 0);
            zoomType = ZoomType.HORIZONTAL;
        }
        if(mPopRbY.isChecked()) {
            SharePrefUtil.saveInt(getApplicationContext(), SharePrefUtil.REPORT_KEY.SELECTYX_MONTH_TYPE, 1);
            zoomType = ZoomType.VERTICAL;
        }
        if(mPopRbYX.isChecked()) {
            SharePrefUtil.saveInt(getApplicationContext(), SharePrefUtil.REPORT_KEY.SELECTYX_MONTH_TYPE, 2);
            zoomType = ZoomType.HORIZONTAL_AND_VERTICAL;
        }

        SharePrefUtil.saveBoolean(getApplicationContext(),SharePrefUtil.REPORT_KEY.TOGGLELABELS_MONTH_ISCHECK,mPopCbToggleLabels.isChecked());
        SharePrefUtil.saveBoolean(getApplicationContext(),SharePrefUtil.REPORT_KEY.TOGGLEFILLED_MONTH_ISCHECK,mPopCbToggleFilled.isChecked());
        SharePrefUtil.saveBoolean(getApplicationContext(),SharePrefUtil.REPORT_KEY.SELECTYX_MONTH_ISCHECK,mPopCbSelectYX.isChecked());
    ...
    private void query(){
        ...
        float[][] NumbersTab = new float[mNum][32];                      // 因为从0开始的，但是坐标我从1开始的所以最大32

        String month1 = mTvMonth1.getText().toString();
        String month2 = mTvMonth2.getText().toString();
        String month3 = mTvMonth3.getText().toString();
        String month4 = mTvMonth4.getText().toString();
        String month5 = mTvMonth5.getText().toString();
        ...
        for (int i=0; i<mNum; i++) {
            ...
            try {
                calendar.setTime(new SimpleDateFormat("yyyy-MM").parse(monthList.get(i)));
            } catch (ParseException e) {
                e.printStackTrace();
            }
//        int year = calendar.get(Calendar.YEAR);       //获取年份
//        int month = calendar.get(Calendar.MONTH);     //获取月份  月份会-1
                    ...
                    if (cursor.getString(0) != null) {        // 没记录，返回1，这里返回的是 "null"
                        if (Float.valueOf(cursor.getString(0)) >= 0) {
                            ...
                            for (int j = 1; j <= dayOfMonth; j++) {
                                System.out.println("循环的:" + monthList.get(i) + "-" + ToFormatUtil.toNumberFormat(j, 2));
                                if (flag) {
                                    System.out.println("text:" + cursor.getString(1) + ":" + cursor.getString(0));
                                    if ((monthList.get(i) + "-" + ToFormatUtil.toNumberFormat(j, 2)).equals(cursor.getString(1))) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            /****************************年份月份**************************************/
            case R.id.tv_month1:                               // 月份1
                mCurrent = 1;
                if (pvTimeYearMonth != null) {
                    pvTimeYearMonth.show();
                }
                break;
            case R.id.tv_month2:                               // 月份2
                mCurrent = 2;
                if (pvTimeYearMonth != null) {
                    pvTimeYearMonth.show();
                }
                break;
            case R.id.tv_month3:                               // 月份3
                mCurrent = 3;
                if (pvTimeYearMonth != null) {
                    pvTimeYearMonth.show();
                }
                break;
            case R.id.tv_month4:                               // 月份4
                mCurrent = 4;
                if (pvTimeYearMonth != null) {
                    pvTimeYearMonth.show();
                }
                break;
            case R.id.tv_month5:                               // 月份5
                mCurrent = 5;
                if (pvTimeYearMonth != null) {
                    pvTimeYearMonth.show();
                }
